...
public final class UrlParser {
	...
	static int @NotNull [] parseQueryParameters(@NotNull String query, int pos, int end) {
		if (pos == end)
	...
	@Nullable
	static String findParameter(@NotNull String src, int @NotNull [] parsedPositions, @NotNull String key) {
	...
	@NotNull
	static List<String> findParameters(@NotNull String src, int @NotNull [] parsedPositions, @NotNull String key) {
